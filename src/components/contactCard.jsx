...
export default function ContactCard({contact}){
  ...
  const deleteContact = async (id)=>{
    ...
    return(
        <div key={contact.id} className='w-[100%] mt-2 flex gap-3 items-center bg-primary rounded-md px-3 py-2 '>
          <HiOutlineUserCircle className='text-accent size-9'/>
          ...
          <div className='flex ml-auto gap-2'>
            ...
            <IoMdTrash 
              ...
              className='size-6 text-accent cursor-pointer'
            />
          </div>
